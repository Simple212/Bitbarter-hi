...
const Main1= ({reverse,value2,change1,value3,value4,value5,value6,value7,value10,value11,changetodoge,changetoltc,changetobtc,changetodoge4,changetoltc4,changetobtc4,event1,value500,from1,to1,value71,value72,value73,value74,value75,value76,call,value1500,value1006,backtohome,changetoxmr,value738,changetoxmr2,value739,value740,value741,changetobnb1,changetobnb2,value750,value751,changetobch1,changetobch2,changetotrx1,value760,value761,value7610,value501,value10070,value1600,changetorose1,event105,changetorose2,changetodash1,send2,first56,first66,changetoavax1,changetoada1,changetovet1,changetoxtz1,value81,changetoeth1,value859,changetosol1,theme,value8591,changetoetc1,changetodark,value1008,value10091,value10092,bg1,value10081,value10082,value10083,changetolight,value10085,logo_value,value10087,value10088,value100910,value10059,value100912,value10057,changetologin,changetosignup})=>{
    ...
    return(
        ...
        <Col className='col-md-3 d-flex justify-content-center align-items-center flex-row' > <a className="btn45 mt-1 me-2 f6 grow no-underline ba bw1 ph2 pv1 mb1 dib b text-white pt-1">सर्च करें</a>
        <input id="name" placeholder='आपकी आर्डर आईडी' className="b input-reset ba b--black-20 pt-2 pb-2 ps-2 db w-60" type="text" aria-describedby="name-desc" /> </Col>
        ...
        <Navbar bg={theme} expand="lg" className='navbar1'>
                    <Container>
                        ...
                        <Nav.Link href="#home" style={{'color':`${value1008}`}} className='d-flex justify-content-center align-items-center navlink'>वालेट <img src={require(`${value10091}`)}   className='ms-2' width={'17px'}/>
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}}>कार्यरत</span>
                        </Nav.Link>
                        <Nav.Link href="#home" style={{'color':`${value1008}`}} className='d-flex justify-content-center align-items-center navlink'>तंत्र स्टेटस <img src={require(`${value10091}`)} className='ms-2' width={'17px'}/>
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >कार्यरत</span></Nav.Link>
                            ...
                            <Nav.Link href="#home" className='d-flex justify-content-center align-items-center navlink'>
                            <Button className='br5 btn_login b shadow-4' onClick={changetologin} >लॉग इन करें</Button>
                            </Nav.Link>
                            
                            <Nav.Link href="#home" className='d-flex justify-content-center align-items-center navlink'>
                            <Button className='br5 btn-danger b shadow-4' onClick={changetosignup}>साइनअप करें</Button>
                            </Nav.Link>
                            ...
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://www.hi.bitbarter.org" target="_blank">हिंदी <img src={require(`./india.jpg`)} className='flag1' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://www.jp.bitbarter.org" target="_blank">日本語 <img src={require(`./japan.png`)} className='flag2' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://www.cn.bitbarter.org" target="_blank">中文 <img src={require(`./china.png`)} className='flag3' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://www.ru.bitbarter.org" target="_blank">руский <img src={require(`./russia.png`)} className='flag4' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://www.bitbarter.org" target="_blank">English <img className='flag5' src={require(`./en.png`)} width='30px' /> </Dropdown.Item>
                            </Dropdown.Menu>
            ...
            <article className="mw7 center br3 pa3 pa4-ns mv3 ba b--black-10 shadow-3" style={{'background-color':`${value100910}`,'border':`${value10057}`}} onClick={() => {
				...
				setLgShow2('SEND')
                    ...
                    <h3 className='b send_r mt-4 mb-1' style={{'color':`${value10059}`}} >आप भेजेंगे</h3>
                ...
                <h3 className='b send_r mt-4 mb-1' style={{'color':`${value10059}`}} >आप प्राप्त करेंगें</h3>
            ...
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p className='b para258' style={{'color':`${value10059}`}}>भेंजनें के लिए राशि तय करें</p>
            ...
            <p className='b text-red text-center tc para3000' style={{'display':`${value501}`}} >न्यूनतम {value3} राशि {lgShow233} है|</p>
            <p className='b text-red text-center tc para3000' style={{'display':`${value1600}`}} >कृपया राशि दर्ज करें</p>
            </Col>
            </Row>
            
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p style={{'color':`${value10059}`}} className='b para10'>प्राप्त करने का पता (अडैरस)</p>
                </Col>
            </Row>
            ...
            <p className='b text-red text-center tc para3000' style={{'display':`${value1500}`}} >कृपया पता (अडैरस) दर्ज करें</p>
                </Col>
            </Row>

            <Row className='mt-3'>
                <Col className='col-md-12 text-black'>
                <Button className='btn2 b shadow-3' style={{'background-color':`${value100910}`,'border':`${value10057}`,'color':`${value10059}`}}  onClick={call}>एक्सचेंज</Button>
                </Col>
            </Row>
      ...
      <h3 className='b tc text-black'>YOU {lgShow2} </h3>
        ...
        <Modal.Body >
            ...
            <h2 className='tc b mt-4 text-center'>बिटबार्टर पर क्रिप्टो को कैसे एक्सचेंज करें</h2>
            <p className='tc text-cente br'>बिटबार्टर पर क्रिप्टो को एक्सचेंज करना सरल और आसान है.</p>
            <p className='tc text-center'>चार चरणों का पालन करें</p>
            ...
            <h6>क्रिप्टो चुनें जिसे आप प्राप्त करना चाहते हैं</h6>
            </Col>
            <Col className='col-md-3 mt-4 mb-4'>
            ...
            <h6>अपना क्रिप्टो वॉलेट पता दर्ज करें</h6>
            </Col>
            <Col className='col-md-3 mt-4 mb-4'>
            ...
            <h6>एक्सचेंज पर क्लिक करें</h6>
            </Col>
            <Col className='col-md-3 mt-4 mb-4'>
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" className="mt-3 mb-3 bi bi-currency-rupee" viewBox="0 0 16 16">
            <path d="M4 3.06h2.726c1.22 0 2.12.575 2.325 1.724H4v1.051h5.051C8.855 7.001 8 7.558 6.788 7.558H4v1.317L8.437 14h2.11L6.095 8.884h.855c2.316-.018 3.465-1.476 3.688-3.049H12V4.784h-1.345c-.08-.778-.357-1.335-.793-1.732H12V2H4v1.06Z"/>
            </svg>
            <h6>तुरंत अपना क्रिप्टो प्राप्त करें</h6>
            </Col>
            </Row>
            </Col>
            </Row>
