        ...
        <Navbar bg={theme} expand="lg" className='navbar1'>
                    <Container>
                        ...
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >कार्यरत</span></Nav.Link>
                            ...
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://hi.bitbarter.org" target="_blank">हिंदी <img src={require(`./india.jpg`)} className='flag1' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://jp.bitbarter.org" target="_blank">日本語 <img src={require(`./japan.png`)} className='flag2' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://cn.bitbarter.org" target="_blank">中文 <img src={require(`./china.png`)} className='flag3' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://ru.bitbarter.org" target="_blank">руский <img src={require(`./russia.png`)} className='flag4' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://bitbarter.org" target="_blank">English <img className='flag5' src={require(`./en.png`)} width='30px' /> </Dropdown.Item>
                            </Dropdown.Menu>
